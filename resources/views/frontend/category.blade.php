          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <li>
                  <figure>
                    <a class="aa-product-img" href="#"><img src="{{asset('storage/media/'.$product->image)}}" alt="polo shirt img"></a>
                          ...
                          <div class="aa-product-view-slider">                                
                            <div class="simpleLens-gallery-container" id="demo-1">
                              ...
                              <div class="simpleLens-thumbnails-container">
                                  <a href="#" class="simpleLens-thumbnail-wrapper" data-lens-image="{{asset('frontend/img/view-slider/large/polo-shirt-1.png')}}" data-big-image="img/view-slider/medium/polo-shirt-1.png">
                                      <img src="{{asset('frontend/img/view-slider/thumbnail/polo-shirt-1.png')}}">
                                  </a>                                    
                                  <a href="#" class="simpleLens-thumbnail-wrapper" data-lens-image="{{asset('frontend/img/view-slider/large/polo-shirt-3.png')}}" data-big-image="{{asset('frontend/img/view-slider/medium/polo-shirt-3.png')}}">
                                      <img src="{{asset('frontend/img/view-slider/thumbnail/polo-shirt-3.png')}}">
                                  </a>

                                  <a href="#" class="simpleLens-thumbnail-wrapper" data-lens-image="{{asset('frontend/img/view-slider/large/polo-shirt-4.png')}}" data-big-image="img/view-slider/medium/polo-shirt-4.png">
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <ul class="aa-catg-nav">
                ...
                <li><a href="{{route('category',$item->category_name)}}">{{$item->category_name}}</a></li>
                @endforeach
              </ul>
            </div>
            <!-- single sidebar -->
